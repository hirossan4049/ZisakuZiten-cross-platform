...
class MainWW(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(len(get_json)):
            ...
            if not get_json[i]["ziten_updT_List"]:
                id_list.append(None)
            else:
                id_list.append(get_json[i]["ziten_updT_List"][0]["group"])
        ...
        # self.ids.testAAA.add_widget(MDCustomListItem(text="a"))
    ...
    def show_snackber(self,position:int):
        ...
        # self.testAAA.TwoLineListItem(text="secondary_text",secondary_text="afa")
